...
public class TargetALL_Adapter extends RecyclerView.Adapter<saneforce.sanclm.Order_Report.Adapter.TargetALL_Adapter.MyViewHolder>  {
...
//            this.PC=PC;
        ...
        @NonNull
        @Override
        public saneforce.sanclm.Order_Report.Adapter.TargetALL_Adapter.MyViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
            LayoutInflater inflater=LayoutInflater.from(context);
            View view=inflater.inflate(R.layout.target_new,null,false);
            return new saneforce.sanclm.Order_Report.Adapter.TargetALL_Adapter.MyViewHolder(view);
        }

        @Override
        public void onBindViewHolder(@NonNull final saneforce.sanclm.Order_Report.Adapter.TargetALL_Adapter.MyViewHolder myViewHolder, final int i) {

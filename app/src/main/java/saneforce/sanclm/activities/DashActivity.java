...
public class DashActivity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    CardView secondary_card,primary_card,primary_card1, mtd_card, qtd_card, ytd_card;
    ...
    ImageView imp_back1, filter_btn1,imp_back_filter1,secondary_sel1,custom_datecheck1;
    ...
    TextView mtdtext1,qtdtext1,ytdtext1,prmtxt,sectxt;
...
//        secondarylayout=findViewById(R.id.secondary_activity);
        ...
        Log.d("intent_count",Dcrdatas.intent_count="1");
        ...
        ActionBarDrawerToggle toggle = new ActionBarDrawerToggle(
                DashActivity.this, drawer, R.string.navigation_drawer_open, R.string.navigation_drawer_close);
...
//        bottomNavigation.setOnNavigationItemSelectedListener(mOnNavigationItemSelectedListener);
        ...
        sqlLite1 = new sqlLite(DashActivity.this);
       ...
       // profilename.setText("NAME");
        ...
        fromdate_ed.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                DatePickerDialog datePickerDialog = new DatePickerDialog(DashActivity.this,
            ...
            public void onClick(View view) {
              //  Toast.makeText(getApplicationContext(),fromdate_ed.getText().toString(),Toast.LENGTH_SHORT).show();
                if (fromdate_ed.getText().toString().equals("")) {
                    ...
                    DatePickerDialog datePickerDialog1 = new DatePickerDialog(DashActivity.this,
                            new DatePickerDialog.OnDateSetListener() {
...
//        String curval = null;
//        List<CustomerMe> CustomerMeList;
//        sqlLite = new sqlLite(DashActivity.this);
//        String username = Shared_Common_Pref.getusernameFromSP(DashActivity.this);
...
//                break;
    ...
    private void Orderproduct_YTDprimary_l(){
        LinearLayoutManager LayoutManagerpoc = new LinearLayoutManager(DashActivity.this);
        recyclerView.setLayoutManager(LayoutManagerpoc);
        recyclerView.setItemAnimator(new DefaultItemAnimator());
        targetadt = new TargetAdapter_new(DashActivity.this, targetdetails, targetSdetails, todate, fromdate, DashActivity.this,secondary_prime);
    ...
    private void YTDALLproduct() {
        ...
        recyclerView.setLayoutManager(LayoutManagerpoc);
        recyclerView.setItemAnimator(new DefaultItemAnimator());
        targetALLAdapter = new TargetALL_Adapter(DashActivity.this,todate, fromdate, DashActivity.this,targetAlls);
...
//            hq_list1id.add(Shared_Common_Pref.getsfcodeFromSP(getActivity()));
            ...
            ArrayAdapter<String> adapter1 = new ArrayAdapter<String>(DashActivity.this, android.R.layout.simple_spinner_dropdown_item, div_list1);
...
//            String startDateStr = dfs.format(monthFirstDay);
            ...
            fromstrdate = startDateStr;
            tostrdate = endDateStr;
...
//            }
            ...
            try {
                ...
                final String finalFromstrdate = fromstrdate;
...
//            String startDateStr = dfs.format(monthFirstDay);
            ...
            Log.e(" order request", "order Detail request");
            Map<String, String> QryParam = new HashMap<>();
            QryParam.put("axn", "get/Primary_YTD_All");
            // if (division_splitting.getVisibility() == View.VISIBLE) {
            ...
            try {
                ...
                call.enqueue(new Callback<JsonArray>() {
                    ...
                    public void onResponse(@NonNull Call<JsonArray> call, @NonNull Response<JsonArray> response) {
                        ...
                        if (response.code() == 200 || response.code() == 201) {
                            Log.d("orderrepor:Res", response.body().toString());
                            parseJsonData_adminchart(response.body().toString(),CustomerMeList.get(0).getDivisionCode(),sfdata,fromdata,todata);
...
//            }
            ...
            frmdates = startDateStr;
            todates = tostrdate;
            Dcrdatas.startdate=frmdates;
            Dcrdatas.enddate=todates;
//            Dcrdatas.division_coderselected = divison_code1;
//            Dcrdatas.sfcode_selected = toback.get(toback.size()-1);
...
//            }
            ...
            try {
                ...
                //Call<JsonArray> call = apiService.getDataAsJArray(AppConfig.getInstance(DashActivity.this).getBaseurl(), QryParam);
                Call<JsonArray> call = apiService.getTargetDataAsJArray(QryParam);
                final String finalFrmdates = frmdates;
                final String finalTodates = todates;
                call.enqueue(new Callback<JsonArray>() {
                    ...
                    public void onResponse(@NonNull Call<JsonArray> call, @NonNull Response<JsonArray> response) {
                        ...
                        if (response.code() == 200 || response.code() == 201) {
                            Log.d("orderrepor:Res", response.body().toString());
                            parseJsonDataorderDetail(response.body().toString());
                            Orderproduct_MTDsecondary(finalFrmdates, finalTodates);
                            //secondaryproduct_detail11(startDateStr, endDateStr);
                        } else {
//                            Log.d("expense:Res", "1112222233333444");
                            Toast.makeText(DashActivity.this, "No records found", Toast.LENGTH_SHORT).show();
...
//            }
            ...
            final String frmdates = fromstrdate;
                ...
                call.enqueue(new Callback<JsonArray>() {
                    ...
                    public void onResponse(@NonNull Call<JsonArray> call, @NonNull Response<JsonArray> response) {
                        ...
                        if (response.code() == 200 || response.code() == 201) {
                            Log.d("orderrepor:Res", response.body().toString());
                            parseJsonDataorderDetail(response.body().toString());
                            Orderproduct_MTDsecondary(frmdates, todates);
                            //secondaryproduct_detail11(fromstrdate, tostrdate);
                        } else {
//                            Log.d("expense:Res", "1112222233333444");
                            Toast.makeText(DashActivity.this, "No records found", Toast.LENGTH_SHORT).show();
...
//                            Log.d("expense:Res", "1112222233333444");
    ...
    private void parseJsonDataPieprimary(String monitor,String div,String sfdata,String from,String to) {
        Log.d("val_data",monitor+"--"+div+"--"+sfdata+"--"+from+"--"+to);
        String date = "";
        try {
            try {
...
//
//        } else {
//            LinearLayoutManager LayoutManagerpoc = new LinearLayoutManager(MainActivity.this);
//            recyclerView.setLayoutManager(LayoutManagerpoc);
//            recyclerView.setItemAnimator(new DefaultItemAnimator());
...
//            recyclerView.setLayoutManager(LayoutManagerpoc);
//            recyclerView.setItemAnimator(new DefaultItemAnimator());
//            targetALLAdapter = new TargetALL_Adapter(MainActivity.this,todate, fromdate,MainActivity.this,targetAlls);
//            recyclerView.setAdapter(targetALLAdapter);
...
//        recyclerView.setLayoutManager(LayoutManagerpoc);
//        recyclerView.setItemAnimator(new DefaultItemAnimator());
//        targetsadt = new Targetadapter_newsecnd(MainActivity.this,targetdetails, targetSdetails,todate,fromdate);
...
//                            Log.d("expense:Res", "1112222233333444");
    ...
    public void parseJsonData_adminchart(String monitor,String div,String sfdata,String from,String to) {
        Log.d("val_data123",monitor+"--"+div+"--"+sfdata+"--"+from+"--"+to);
        String date = "";
        try {
            try {
                JSONArray js = new JSONArray(monitor);
...
//                            Log.d("expense:Res", "1112222233333444");
    ...
    public void showchartdetails(final String label, float y, ArrayList<String> piedata, int position){
        ...
        android.app.AlertDialog.Builder dialogBuilder = new android.app.AlertDialog.Builder(DashActivity.this);
        LayoutInflater inflater = DashActivity.this.getLayoutInflater();
        ...
        infobut.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent oo = new Intent(DashActivity.this, Web_Activity.class);

...
public class DemoActivityOld extends AppCompatActivity {
    ViewPager viewpager;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (!language.equals("")){
            ...
            selected(language);
            context = LocaleHelper.setLocale(DemoActivityOld.this, language);
            resources = context.getResources();
        }else {
            selected("en");
            context = LocaleHelper.setLocale(DemoActivityOld.this, "en");
            resources = context.getResources();
        }
       ...
       if(SF_Type.equalsIgnoreCase("2")){
        ...
        if(CommonUtilsMethods.isOnline(DemoActivityOld.this)){
                getTpsetup();
        }
        else
       ...
       // del_session.setVisibility(View.GONE);
        ...
        pagerAdapter = new MyCustomTPPager(DemoActivityOld.this,aa);
                    ...
                    if(!mCommonSharedPreference.getValueFromPreference("approve").equalsIgnoreCase("null")&&
                        ...
                        try {
                            ...
                            if (expand_list.getVisibility() == View.VISIBLE) {
                                ...
                                AdapterExpand adpt = new AdapterExpand(DemoActivityOld.this, nameCodeExpand, selectCategory);
...
/*
                            ...
                            AdapterForSelectionList adpt = new AdapterForSelectionList(DemoActivityOld.this, nameCode, selectCategory);
        ...
        back_icon.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if(HomeDashBoard.tpCount==0) {
                    Intent i = new Intent(DemoActivityOld.this, HomeDashBoard.class);
                    startActivity(i);
                }
            }
        });
                        ...
                        for (int i = 0; i < aa.size(); i++) {
                            ...
                            try {
                                if (!TextUtils.isEmpty(tp.getWrk())) {
                                    for (int k = 0; k < DemoActivityOld.list_wrk.size(); k++) {

                                        ModelWorkType kk = DemoActivityOld.list_wrk.get(k);
...
*/
                        ...
                        finalValue.add(js.toString());*/
                                ...
                                calAdapt = new CalendarAdapter(DemoActivityOld.this, jj.toString());
...
/* int pos=work.indexOf("$");
                ...
                if(TextUtils.isEmpty(work) || TextUtils.isEmpty(hq) || TextUtils.isEmpty(cluster) || TextUtils.isEmpty(joint)
                    ...
                    Toast.makeText(DemoActivityOld.this,"Fill all the field",)
                }*//*
            ...
            public void onClick(View view) {
                ...
                if(cur2.getCount()>0){
                    while(cur2.moveToNext()) {
                        ...
                        calAdapt = new CalendarAdapter(DemoActivityOld.this, cur2.getString(2));
                        grid_cal.setAdapter(calAdapt);
                   ...
                   /* if(TextUtils.isEmpty(CalendarAdapter.arr_json.get(i).getCode()) && !TextUtils.isEmpty(aa.get(0).getWrk())){
                    ...
                    /*else*/ if(TextUtils.isEmpty(CalendarAdapter.arr_json.get(i).getCode())){
                        ...
                        try {
                            ...
                            AdapterTpViewEntry adpt=new AdapterTpViewEntry(DemoActivityOld.this,viewTp);
            ...
            public void onClick(View view) {
                ...
                if(expand_list.getVisibility()==View.VISIBLE){
                   ...
                   /* }
                        ...
                        Toast.makeText(DemoActivityOld.this,"Atleast select one field",Toast.LENGTH_SHORT).show();*/
                }
                else{
...
*/
               /* else
                    Toast.makeText(DemoActivityOld.this,"Kindly select the item",Toast.LENGTH_SHORT).show();*/
/*
               if(drNeed.equalsIgnoreCase("1")) {
                   try {
                       if (SF_Type.equalsIgnoreCase("2")) {
...
*/
    ...
    public void getInsertValue(){
        ...
        if(cur.getCount()>0){
            while(cur.moveToNext()) {
                ...
                calAdapt = new CalendarAdapter(DemoActivityOld.this, cur.getString(2));
                grid_cal.setAdapter(calAdapt);
            }
        }
        else{
    ...
    public void dayCaldumm() {
        try {
           ...
           /* jsonObject1.put("SF",SF_Code);
            ...
            calAdapt = new CalendarAdapter(DemoActivityOld.this, jsonObject1.toString());
            grid_cal.setAdapter(calAdapt);
            //calAdapt.notifyDataSetChanged();
    ...
    public void setColoredDot(Button btn){
        ...
        if(sdk < android.os.Build.VERSION_CODES.JELLY_BEAN) {
            btn.setBackgroundDrawable(ContextCompat.getDrawable(DemoActivityOld.this, R.drawable.shape_plain_grey_circle_tp) );
        } else {
            btn.setBackground(ContextCompat.getDrawable(DemoActivityOld.this, R.drawable.shape_plain_grey_circle_tp));
        }
    }
    public void setColoredDotRed(Button btn){
        final int sdk = android.os.Build.VERSION.SDK_INT;
        if(sdk < android.os.Build.VERSION_CODES.JELLY_BEAN) {
            btn.setBackgroundDrawable(ContextCompat.getDrawable(DemoActivityOld.this, R.drawable.shape_plain_red_circle_tp) );
        } else {
            btn.setBackground(ContextCompat.getDrawable(DemoActivityOld.this, R.drawable.shape_plain_red_circle_tp));
        }
    }
    public void showToast(String msg){
        ...
        try {
            ...
            try {
                Toast.makeText(DemoActivityOld.this, msg, Toast.LENGTH_SHORT).show();
            }catch (Exception e1){
                Toast.makeText(getApplicationContext(), msg, Toast.LENGTH_SHORT).show();
            }
        }
                ...
                addSession(count);
                               /* btnAry=new Button[count];
                                for(int k=0;k<count;k++){
                                    Button btnTag = new Button(DemoActivityOld.this);
                                    btnTag.setTag(k);
                ...
                if (response.isSuccessful()) {
                    ...
                    try {
                        ...
                        if(js.getString("success").equalsIgnoreCase("true")) {
                            ...
                            if(x==2){
                                showToast(/*"Successfully sent"*/ resources.getString(R.string.sent_suxs));
                                Intent i=new Intent(DemoActivityOld.this,ApprovalActivity.class);
                                startActivity(i);
                            }
                        }
                    } catch (Exception e) {
...
*/
    ...
    public void alertForReject(int x){
        final Dialog dialog=new Dialog(DemoActivityOld.this,R.style.AlertDialogCustom);

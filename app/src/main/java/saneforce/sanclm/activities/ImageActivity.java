...
public class ImageActivity extends AppCompatActivity {
    ...
    public void init() {
        ...
        done=findViewById(R.id.savebtn);
        done.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent=new Intent(ImageActivity.this,NewRCBentryActivity.class);
                intent.putExtra("mylist", selectedImageList);
    ...
    public void setSelectedImageList() {
        ...
        selectedImageAdapter = new SelectedImageAdapter(this, selectedImageList,imageList);

    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState)
    {
        ...
        try
        {
           ...
           if(commonSharedPreference.getValueFromPreference("cip_need").equals("0"))
            mTabHost.addTab(mTabHost.newTabSpec("4").setIndicator(getTabIndicator(mTabHost.getContext(), commonSharedPreference.getValueFromPreference("cipcap"), R.drawable.chem_tab)),DCRCIPCallsSelection.class, null);

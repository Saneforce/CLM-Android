...
import com.example.myapplication.Common_Class.Dcrdatas;
import com.example.myapplication.Common_Class.Shared_Common_Pref;
import com.example.myapplication.Common_Class.sqlLite;
import com.example.myapplication.DashActivity;
import com.example.myapplication.Order_Report.Adapter.TargetAdapter_new;
import com.example.myapplication.Order_Report.Adapter.TargetAllsec_Adapter;
import com.example.myapplication.Order_Report.Adapter.Targetadapter_newsecnd;
...
import com.example.myapplication.Order_Report.modelclass.secondarysales_class;
...
//import com.example.native_san_sfe_report.Activity.Login_Activity;
...
//import com.example.native_san_sfe_report.Common_Class.Shared_Common_Pref;
//import com.example.native_san_sfe_report.Common_Class.sqlLite;
//
//import com.example.native_san_sfe_report.Order_Report.Adapter.TargetAdapter_new;
//import com.example.native_san_sfe_report.Order_Report.Adapter.TargetAllsec_Adapter;
//import com.example.native_san_sfe_report.Order_Report.Adapter.Targetadapter_newsecnd;
...
//import com.example.native_san_sfe_report.Order_Report.modelclass.secondarysales_class;
//import com.example.native_san_sfe_report.Order_Report.modelclass.targetAll;
//import com.example.native_san_sfe_report.R;
//import com.example.native_san_sfe_report.SFE_report.Activity.SFE_Activtity;
...
//                    int f1day = Integer.parseInt(frommedate[2]);
        ...
        Log.d("username",CustomerMeList.get(0).getUsername());
        profilename.setText(CustomerMeList.get(0).getSFName());
...
//        division_splitting1.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
//            @Override
//            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
//                if(div_list11.get(position).equalsIgnoreCase("All")){
//                    divison_code="";
//                    for (int i=0;i<div_list1id1.size();i++){
//                        if(i==0){
//                            // divison_code = div_list1id.get(position);
//                        }else{
//                            divison_code = divison_code+div_list1id1.get(i);
//                        }
//
//                    }
//                }else{
//                    divison_code = div_list1id1.get(position);
//                }
//
//
//                Log.d("11111", "one");
...
//            @Override
//            public void onClick(View view) {
//                if(secondary_sel1.getTag().equals("check")){
////                    getFragmentManager().beginTransaction().replace(R.id.DCRMain_Frame, new Target_Vs_Sales()).commit();
////                    Intent oo=new Intent(Target_Vs_Secondary.this, Target_Vs_Secondary.class);
////                    startActivity(oo);
//                }
//                else if(selected_data1.equalsIgnoreCase("MTD")) {
//                    MTDprimeproduct();
//                    Orderproduct_PiechartSecondaryMTD();
//                    //  primartext.setText("Primary");
//                }
//                else if(selected_data1.equalsIgnoreCase("QTD")) {
//                    Orderproduct_QTDSecondary();
//                    Orderproduct_PiechartSecondaryMTD();
//                }
//                else if(selected_data1.equalsIgnoreCase("YTD")) {
//                    Orderproduct_YTDSecondary();
//                    Orderproduct_PiechartSecondaryMTD();
//                }
//                else if(custom_datecheck1.getTag().toString().equalsIgnoreCase("check")){
//                    if(fromdate_ed1.getText().toString().equalsIgnoreCase("")||todate_ed1.getText().toString().equalsIgnoreCase("")){
//                        Toast.makeText(Target_Vs_Secondary.this,"Please Fill From date and To date",Toast.LENGTH_SHORT).show();
//                    }else {
//                        secondaryproduct();

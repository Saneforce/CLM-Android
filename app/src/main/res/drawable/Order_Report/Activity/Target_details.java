...
//        });
    ...
    private void Orderproduct_Piechart() {
        try {
            ...
            String curval = null;
            List<CustomerMe> CustomerMeList;
            sqlLite = new sqlLite(Target_details.this);
            String username = Shared_Common_Pref.getusernameFromSP(Target_details.this);
...
//            }
            ...
            QryParam.put("divisionCode", Dcrdatas.division_coderselected);
            QryParam.put("sfCode",Dcrdatas.sfcode_selected);
            QryParam.put("rSF", Shared_Common_Pref.getsfcodeFromSP(Target_details.this));
                ...
                call.enqueue(new Callback<JsonArray>() {
                    ...
                    public void onResponse(@NonNull Call<JsonArray> call, @NonNull Response<JsonArray> response) {
                        ...
                        if (response.code() == 200 || response.code() == 201) {
                            ...
                            parseJsonDataPieprimary(response.body().toString(),Dcrdatas.division_coderselected,Dcrdatas.sfcode_selected,Dcrdatas.startdate,Dcrdatas.enddate);
                        } else {
            ...
            try {
                ...
                call.enqueue(new Callback<JsonArray>() {
                    ...
                    public void onResponse(@NonNull Call<JsonArray> call, @NonNull Response<JsonArray> response) {
                        ...
                        if (response.code() == 200 || response.code() == 201) {
                            Log.d("orderrepor:Res", response.body().toString());
                            parseJsonDataPieSecondary(response.body().toString(),Dcrdatas.division_coderselected,Dcrdatas.sfcode_selected,Dcrdatas.startdate,Dcrdatas.enddate);
                        } else {
//                            Log.d("expense:Res", "1112222233333444");
                            Toast.makeText(getApplicationContext(), "No records found", Toast.LENGTH_SHORT).show();
                        }

...
public class TargetALL_Adapter extends RecyclerView.Adapter<com.example.myapplication.Order_Report.Adapter.TargetALL_Adapter.MyViewHolder>  {
        ...
        public TargetALL_Adapter(Context context,TextView tx1, TextView tx2, AppCompatActivity fragment,ArrayList<targetAll> targetAlls
...
//            this.PC=PC;
        ...
        @NonNull
        @Override
        public com.example.myapplication.Order_Report.Adapter.TargetALL_Adapter.MyViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
            LayoutInflater inflater=LayoutInflater.from(context);
            View view=inflater.inflate(R.layout.target_new,null,false);
            return new com.example.myapplication.Order_Report.Adapter.TargetALL_Adapter.MyViewHolder(view);
        }

        @Override
        public void onBindViewHolder(@NonNull final com.example.myapplication.Order_Report.Adapter.TargetALL_Adapter.MyViewHolder myViewHolder, final int i) {
...
//                    rotationAngle = rotationAngle%360;
                ...
                nxt.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        ...
                        if(temp.indexOf("G")!=-1)
                        {
                            ((DashActivity) fragment).getsubdata(targetPrimaryClass.getSf_code(),targetPrimaryClass.getDivision_code());
                            //  System.out.println("there is 'b' in temp string");
                        }
                        else if(temp.equalsIgnoreCase("Admin")){
                            ((DashActivity) fragment).getsubdata1(targetPrimaryClass.getSf_code(),targetPrimaryClass.getDivision_code());
                        }
                        else
                        {
                ...
                prev.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        ...
                        if (temp.equalsIgnoreCase("Admin")){
                            ((DashActivity) fragment). getbackdata();
                        }else {
                            ((DashActivity) fragment). getbackdatas(temp,div);
                        }
                    }
                });
            }

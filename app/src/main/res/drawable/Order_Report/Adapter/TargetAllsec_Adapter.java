package com.example.myapplication.Order_Report.Adapter;
...
//import com.example.native_san_sfe_report.Activity.MainActivity;
//import com.example.native_san_sfe_report.Common_Class.Dcrdatas;
//import com.example.native_san_sfe_report.Order_Report.Activity.Target_Vs_Secondary;
//import com.example.native_san_sfe_report.Order_Report.modelclass.Primarysales_class;
//import com.example.native_san_sfe_report.Order_Report.modelclass.TargetPrimary_Class;
//import com.example.native_san_sfe_report.Order_Report.modelclass.TargetSecondary_class;
//import com.example.native_san_sfe_report.Order_Report.modelclass.targetAll;
...
import com.example.myapplication.Order_Report.Activity.Target_Vs_Secondary;
import com.example.myapplication.Order_Report.modelclass.Primarysales_class;
import com.example.myapplication.Order_Report.modelclass.TargetPrimary_Class;
import com.example.myapplication.Order_Report.modelclass.TargetSecondary_class;
import com.example.myapplication.Order_Report.modelclass.targetAll;
import com.example.myapplication.R;

public class TargetAllsec_Adapter extends RecyclerView.Adapter<com.example.myapplication.Order_Report.Adapter.TargetAllsec_Adapter.MyViewHolder>  {
    ...
    ArrayList<targetAll> targetAlls;
    ...
    public TargetAllsec_Adapter(Context context,TextView tx1, TextView tx2, AppCompatActivity fragment,ArrayList<targetAll> targetAlls
//                ,ArrayList<String> division_code,
//                                 ArrayList<String> Division_Name,ArrayList<String> Target,ArrayList<String> Sale,ArrayList<String> achiev,ArrayList<String> PSale,
//                                 ArrayList<String> Growth,ArrayList<String> PC
    ) {
        this.context = context;
        this.tx1=tx1;
        this.tx2=tx2;
        this.fragment = fragment;
        this.targetAlls=targetAlls;
...
//            this.PC=PC;
    ...
    @NonNull
    @Override
    public com.example.myapplication.Order_Report.Adapter.TargetAllsec_Adapter.MyViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        LayoutInflater inflater=LayoutInflater.from(context);
        View view=inflater.inflate(R.layout.target_secondary,null,false);
        return new com.example.myapplication.Order_Report.Adapter.TargetAllsec_Adapter.MyViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull final com.example.myapplication.Order_Report.Adapter.TargetAllsec_Adapter.MyViewHolder myViewHolder, final int i) {
//            final TargetPrimary_Class targetPrimary_class=targetdetails.get(i);
        ...
        targetAll target_class=targetAlls.get(i);
        myViewHolder.tv_name.setText(target_class.getDivision_Name());
        myViewHolder.tv_target.setText(target_class.getTarget());
        sales=Double.parseDouble(target_class.getSale());
        myViewHolder.tv_sales.setText(String.format("%.2f", sales));
        myViewHolder.tv_arch.setText(target_class.getAchiec());
        myViewHolder.tv_growth.setText(target_class.getGrowth());
        myViewHolder.tv_pcpm.setText(target_class.getPC());
        dou=Double.parseDouble(target_class.getGrowth());
...
//        Dcrdatas.primaryvalue=String.format("%.2f", sales);
        boolean isxpanded=targetAlls.get(i).isExpanded();
...
//                    in.putExtra("title", Division_Name.get(i));
//                    in.putExtra("primary", String.format("%.2f", sales));
//                    in.putExtra("Target",Target.get(i));
//                    in.putExtra("growth",String.valueOf(String.format("%.2f",dou)));
//                    in.putExtra("acheive",achiev.get(i));
//                    if (tx1.getText().toString().startsWith("T")) {
...
////                }
////                    in.putExtra("Sec", targetSecondary_classes.get(jk).getSl_Secondary());
        ...
        public MyViewHolder(@NonNull View itemView) {
            ...
            lvname.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    targetAll targetPrimaryClass=targetAlls.get(getAdapterPosition());
...
//                    rotationAngle = rotationAngle%360;
            ...
            nxt.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    if(temp.indexOf("G")!=-1)
                    {
                        ((Target_Vs_Secondary) fragment).getsubdata(targetPrimaryClass.getSf_code(),targetPrimaryClass.getDivision_code());
                        //  System.out.println("there is 'b' in temp string");
                    }
                    else if(temp.equalsIgnoreCase("Admin")){
                        (( Target_Vs_Secondary ) fragment).getsubdata1(targetPrimaryClass.getSf_code(),targetPrimaryClass.getDivision_code());
                    }
                    else
                    {
                        System.out.println("there is no 'G' in temp string"+temp);
                    }
                }
            });
            prev.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    targetAll targetPrimaryClass=targetAlls.get(getAdapterPosition());
                    String temp = targetPrimaryClass.getSf_code();
                    String div = targetPrimaryClass.getDivision_code();
                    Log.d("temp",temp);
                    if (temp.equalsIgnoreCase("Admin")){
                        ((Target_Vs_Secondary) fragment). getbackdata();
                    }else {
                        ((Target_Vs_Secondary) fragment). getbackdatas(temp,div);
                    }
                }
            });
        }

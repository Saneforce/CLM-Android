...
import com.example.myapplication.Order_Report.Activity.Target_details;
...
public class Targetadapter_newsecnd extends RecyclerView.Adapter<Targetadapter_newsecnd.MyViewHolder> {
    ...
    public Targetadapter_newsecnd(Context context, ArrayList<TargetPrimary_Class> targetdetails, ArrayList<TargetSecondary_class> targetSecondary_classes, TextView tx1, TextView tx2, AppCompatActivity fragment,ArrayList<String> growthvalue,ArrayList<String> archeivevalue,ArrayList<String> targetvalue,ArrayList<String> primevalue) {
        ...
        this.archeivevalue = archeivevalue;
...
//            todate.setText(output.format(formattedDate2)); // format output
        ...
        myViewHolder.liner_details.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                jk=i;
                dou = Double.parseDouble(growthvalue.get(jk));
...
//                in.putExtra("Todate",yyy);
                ...
                in.putExtra("title", targetPrimary_class.getSf_name());
                in.putExtra("primary", primevalue.get(jk));
                in.putExtra("Target",targetvalue.get(jk));
                in.putExtra("growth",String.valueOf(String.format("%.2f",dou)));
                in.putExtra("acheive",archeivevalue.get(jk));
                if (tx1.getText().toString().startsWith("T")) {
                    in.putExtra("prr", String.format("%.2f", target4));
                    in.putExtra("pcr",String.format("%.2f", sales));
                }else {
...
//                    Dcrdatas.online_primary1=targetSecondary_classes.get(j).getSl_Secondary();
//                }
                in.putExtra("Sec", String.format("%.2f", sales));
                in.putExtra("Fromdate",hhh);
                in.putExtra("Todate",yyy);
...
//                    rotationAngle = rotationAngle%360;
            ...
            nxt.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    if(temp.indexOf("G")!=-1)
                    {
                        ((Target_Vs_Secondary) fragment).getsubdata(targetPrimaryClass.getSf_code(),targetPrimaryClass.getDiv_code());
            ...
            prev.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    ((Target_Vs_Secondary) fragment). ytdback(divs);
                }
            });
        }
    }
